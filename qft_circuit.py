...
basis_gates_nft = ['rx', 'ry','rz', 'cx']
basis_gates_ft = ['t', 'tdg','h','s','sdg','x','y','z','cx']
...
qasm_code = dumps(qc_transpiled_nft)
with open(f"C:/Users/Butch/Desktop/OneDrive - Stony Brook University/TON/qcirc_construction/qft_circuits/qft_circuit({num_qubit}qubits.txt", "w") as file:
    file.write(qasm_code)
# 绘制电路
